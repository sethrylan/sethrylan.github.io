...
2. Import project from external model
  <br>
  <a class="fancybox center" href="/images/2013-07/intellij-import.png"><img src="/images/2013-07/intellij-import.png" width="80%"/></a>
...
4. Right-click parent folder in project structure, select ```Add Framework Support...```.
  <br>
  <a class="fancybox center" href="/images/2013-07/add-framework.png"><img src="/images/2013-07/add-framework.png" width="80%"/></a>
5. Depending on your Scala installation, some expected folders may be missing.
  <br>
  <a class="fancybox center" href="/images/2013-07/add-scala-framework.png">
  <img src="/images/2013-07/add-scala-framework.png" width="80%"/></a>
