...
Manually adding sourcesets will allow us to add the plugins, but the task dependencies are obviously not going to work, unless you want to configure a Java build parallel to an Android build.
